...
echo -e "\033[1mPlease select if you want to apply the custom Mac OSX configuration\033[0m:"
echo -e "[1] Apply the configuration"
echo -e "[2] Skip applying the configuration"
echo
...
case $applyConfiguration in
    ...
    *)
        echo
        echo -e "\033[1mSkipped applying custom Mac OSX configuration\033[0m"
        ;;
esac
